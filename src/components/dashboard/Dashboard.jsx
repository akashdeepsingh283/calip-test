  ...
  return (
    <div className="min-h-screen bg-[#fbfbf9]">
      ...
      <main className="mx-auto max-w-[1440px] px-4 pb-10 sm:px-[30px]">
        ...
        <div className="mt-6 grid grid-cols-1 gap-[30px] xl:mt-[30px] xl:grid-cols-[885fr_434fr]">
          <PortfolioChart />
          <SectorAllocation />
        </div>

        <div className="mt-6 grid grid-cols-1 gap-[30px] lg:mt-[30px] lg:grid-cols-2">
          <RecentActivity />
          <AIRecommendations />
        </div>
      </main>
